...
void myHelper::MyLoginBlog(QString tablename, QString Trigger, QString BlogContent, QString UserName)
{
    ...
    bool ok = query.prepare("INSERT INTO logblog VALUES(:TriggerTimer,:Trigger,:TriggerContent,:TriggerUser);");
    ...
    query.exec();
    //    //query.prepare("INSERT INTO " + tablename + " VALUES (\""+currentDateTime+"\",\""+ Trigger + "\",\""+ BlogContent +"\",\""+ UserName +"\");");
